                        ...
                        {filteredConversations.length === 0 ? (
                            ...
                            filteredConversations.map((conv, idx) => (
                                <motion.button
                                    ...
                                    className={`w-full text-left p-4 rounded-2xl transition-all flex gap-4 group relative cursor-pointer ${
                                ...
                                {isLoadingMessages ? (
                                    ...
                                    <div className="mb-2">
                                        {msg.media_type === 'image' ? (
                                            ...
                                            <a href={msg.media_url} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 bg-black/5 dark:bg-white/5 rounded-2xl hover:bg-black/10 dark:hover:bg-white/10 transition-colors cursor-pointer">
                                ...
                                <form onSubmit={handleSendMessage} className="flex items-center gap-3 relative">
                                    ...
                                    <div className="flex items-center gap-1 relative" ref={emojiPickerRef}>
                                        ...
                                        <button
                                            ...
                                            className={`w-9 h-9 rounded-xl flex items-center justify-center shrink-0 transition-all active:scale-95 cursor-pointer ${
                                        ...
                                        <button
                                            ...
                                            className="w-9 h-9 rounded-xl flex items-center justify-center shrink-0 transition-all hover:bg-zinc-100 dark:hover:bg-zinc-800 active:scale-95 text-zinc-400 hover:text-emerald-500 cursor-pointer"
                                        >
                                                            ...
                                                            <div className="grid grid-cols-8 gap-0.5">
                                                                {cat.emojis.map(emoji => (
                                                                    <button
                                                                        ...
                                                                        className="text-xl p-1.5 rounded-xl hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors leading-none cursor-pointer"
                                                                    >
                                                                        {emoji}
                                                                    </button>
                                                                ))}
                                        ...
                                        {selectedFile && (
                                            <div className="flex items-center gap-3 p-3 bg-zinc-100 dark:bg-zinc-800 rounded-2xl border border-zinc-200 dark:border-white/5">
                                                ...
                                                <button 
                                                    ...
                                                    className="p-1.5 hover:bg-zinc-200 dark:hover:bg-zinc-700 rounded-full transition-colors cursor-pointer"
                                                >
                                    ...
                                    <button
                                        ...
                                        className={`w-11 h-11 rounded-2xl flex items-center justify-center shrink-0 transition-all active:scale-95 shadow-lg cursor-pointer ${
                                            messageMode === 'note' 
