            ...
            <aside className="w-64 border-r border-zinc-200 dark:border-white/10 hidden md:flex flex-col">
                ...
                <div className="p-4 border-t border-zinc-200 dark:border-white/10">
                    ...
                    <form action="/auth/signout" method="post">
                        <button className="w-full flex items-center gap-2 px-2 py-1.5 text-sm font-semibold text-red-600 hover:text-red-500 dark:text-red-400 dark:hover:text-red-300 transition-all hover:translate-x-1 group">
