    ...
    return (
        <div className="glass-strong p-6 sm:p-12 rounded-3xl sm:rounded-[3.5rem] shadow-[0_32px_100px_rgba(0,12,36,0.5)] relative overflow-hidden border-white/10 w-full max-w-md mx-auto">
            <div className="mb-12 text-center flex flex-col items-center">
                ...
                <h1 className="text-xs font-display font-black tracking-[0.4em] uppercase text-brand-300 mb-3">RECUPERAR ACESSO</h1>
                <p className="text-[10px] font-display font-black uppercase tracking-[0.4em] text-white/30">
                    {sent ? 'VERIFIQUE SEU E-MAIL' : 'INSIRA SEU E-MAIL CADASTRADO'}
                </p>
            </div>
                ...
                <form className="flex flex-col gap-8">
                    <div className="flex flex-col gap-3">
                        ...
                        <input
                            ...
                            name="email"
                            type="email"
                            placeholder="agente@mentor-crm.com"
                            required
                        />
                    </div>
                    <div className="pt-4">
