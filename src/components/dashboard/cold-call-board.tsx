...
export function ColdCallBoard({
    ...
    const handleDownloadPDF = () => {
        ...
        const dateStr = `${format(days[0], 'dd/MM/yyyy')} - ${format(days[4], 'dd/MM/yyyy')}`

        // Header Title
        doc.setFontSize(22)
        doc.setTextColor(79, 70, 229) // Indigo-600
        doc.text('Weekly Performance Planner', 15, 20)
        
        // Metadata
        doc.setFontSize(10)
        doc.setTextColor(107, 114, 128)
        doc.text(`Week ${weekNumber} | Year ${year}`, 15, 28)
        doc.text(`Period: ${dateStr}`, 15, 33)
        ...
        autoTable(doc, {
            ...
            columnStyles: {
                ...
                1: { fillColor: [243, 244, 246], fontStyle: 'bold', halign: 'center' },
                7: { fillColor: [243, 244, 246], fontStyle: 'bold', halign: 'center' },
                8: { halign: 'center' }
            },
            bodyStyles: {
                halign: 'center',
        ...
        doc.text('Generated by Mentor CRM - High Performance Sales Management System', 15, finalY + 15)

        doc.save(`Performance_Planner_W${weekNumber}_${year}.pdf`)
    }
